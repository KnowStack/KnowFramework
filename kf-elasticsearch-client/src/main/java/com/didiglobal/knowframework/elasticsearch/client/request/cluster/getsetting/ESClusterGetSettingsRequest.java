...
package com.didiglobal.knowframework.elasticsearch.client.request.cluster.getsetting;
...
public class ESClusterGetSettingsRequest extends ESActionRequest<ESClusterGetSettingsRequest> {
    ...
    public RestRequest toRequest() throws Exception {
        return new RestRequest("GET", "/_cluster/settings", null);
    }

    @Override
    public ESActionResponse toResponse(RestResponse response) throws Exception {
        String respStr = response.getResponseContent();
        return JSON.parseObject(respStr, ESClusterGetSettingsResponse.class);
    }
}
