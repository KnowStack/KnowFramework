...
public class ESIndicesCloseIndexAction extends Action<ESIndicesCloseIndexRequest, ESIndicesCloseIndexResponse, ESIndicesCloseIndexRequestBuilder> {
    ...
    @Override
    public ESIndicesCloseIndexResponse newResponse() {
        return new ESIndicesCloseIndexResponse();
    }

    @Override
    public ESIndicesCloseIndexRequestBuilder newRequestBuilder(ElasticsearchClient client) {
        return new ESIndicesCloseIndexRequestBuilder(client, this);
    }
}
