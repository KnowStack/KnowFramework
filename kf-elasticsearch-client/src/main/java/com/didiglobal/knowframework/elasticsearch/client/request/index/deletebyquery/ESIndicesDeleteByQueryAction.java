...
package com.didiglobal.knowframework.elasticsearch.client.request.index.deletebyquery;
...
public class ESIndicesDeleteByQueryAction extends Action<ESIndicesDeleteByQueryRequest, ESIndicesDeleteByQueryResponse, ESIndicesDeleteByQueryRequestBuilder> {
    ...
    @Override
    public ESIndicesDeleteByQueryResponse newResponse() {
        return new ESIndicesDeleteByQueryResponse();
    }

    @Override
    public ESIndicesDeleteByQueryRequestBuilder newRequestBuilder(ElasticsearchClient client) {
        return new ESIndicesDeleteByQueryRequestBuilder(client, this);
    }
}
