...
package com.didiglobal.knowframework.elasticsearch.client.request.index.closeindex;
...
public class ESIndicesCloseIndexRequest extends ESActionRequest<ESIndicesCloseIndexRequest> {

    private String[] indices;

    public ESIndicesCloseIndexRequest setIndices(String... indices) {
    ...
    public RestRequest toRequest() throws Exception {
        ...
        String endPoint = "/" + indicesStr + "/_close";
    ...
    public ESActionResponse toResponse(RestResponse response) throws Exception {
        ...
        return JSON.parseObject(respStr, ESIndicesCloseIndexResponse.class);
    }
