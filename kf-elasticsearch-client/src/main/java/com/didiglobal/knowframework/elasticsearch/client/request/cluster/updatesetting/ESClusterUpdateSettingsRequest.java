...
package com.didiglobal.knowframework.elasticsearch.client.request.cluster.updatesetting;
...
public class ESClusterUpdateSettingsRequest extends ESActionRequest<ESClusterUpdateSettingsRequest> {
    ...
    public ESClusterUpdateSettingsRequest addTransient(String key, Object value) {
        transients.put(key, value);

        return this;
    }

    public ESClusterUpdateSettingsRequest addPersistent(String key, Object value) {
    ...
    private void addSetting(String name, Map<String, Object> m, JSONObject root) {
        if (m.size() == 0) {
            return;
        }
