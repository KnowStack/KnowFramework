...
public class ESIndicesFreezeIndexRequest extends ESActionRequest<ESIndicesFreezeIndexRequest> {

    private String[] indices;
    private boolean freeze = true;

    public ESIndicesFreezeIndexRequest setIndices(boolean freeze, String... indices) {
        this.freeze = freeze;
    ...
    public ESActionResponse toResponse(RestResponse response) throws Exception {
        ...
        return JSON.parseObject(respStr, ESIndicesFreezeIndexResponse.class);
    }
