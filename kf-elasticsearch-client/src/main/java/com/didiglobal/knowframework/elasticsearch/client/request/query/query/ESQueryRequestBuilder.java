...
package com.didiglobal.knowframework.elasticsearch.client.request.query.query;
...
public class ESQueryRequestBuilder extends ActionRequestBuilder<ESQueryRequest, ESQueryResponse, ESQueryRequestBuilder> {
     ...
     * @param terminateAfter terminateAfter
     * @return ESQueryRequestBuilder
     */
    ...
    /**
     * Constructs a new search source builder with a raw search query.
     * @param queryBinaryOffset queryBinaryOffset
     * @param queryBinaryLength queryBinaryLength
     * @param queryBinary queryBinary
     * @return ESQueryRequestBuilder
     */
