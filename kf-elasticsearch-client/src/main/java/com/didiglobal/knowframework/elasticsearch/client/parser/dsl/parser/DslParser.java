package com.didiglobal.knowframework.elasticsearch.client.parser.dsl.parser;
...
import com.didiglobal.knowframework.elasticsearch.client.parser.dsl.parser.aggr.AggsParser;
...
public abstract class DslParser {
    ...
    static {
        ...
        ParserRegister.registe(ParserType.COMMON, "version", new VersionParser(ParserType.COMMON));
