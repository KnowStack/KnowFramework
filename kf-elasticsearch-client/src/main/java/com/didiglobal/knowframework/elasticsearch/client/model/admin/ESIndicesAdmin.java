package com.didiglobal.knowframework.elasticsearch.client.model.admin;

import com.didiglobal.knowframework.elasticsearch.client.request.dcdr.*;
import com.didiglobal.knowframework.elasticsearch.client.request.ingest.*;
...
import com.didiglobal.knowframework.elasticsearch.client.request.index.clearcache.ESIndicesClearCacheRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.clearcache.ESIndicesClearCacheRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.closeindex.ESIndicesCloseIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.closeindex.ESIndicesCloseIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.closeindex.ESIndicesCloseIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deleteIndex.ESIndicesDeleteIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deleteIndex.ESIndicesDeleteIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deleteIndex.ESIndicesDeleteIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deletebyquery.ESIndicesDeleteByQueryAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deletebyquery.ESIndicesDeleteByQueryRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deletebyquery.ESIndicesDeleteByQueryRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deletetemplate.ESIndicesDeleteTemplateAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deletetemplate.ESIndicesDeleteTemplateRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.deletetemplate.ESIndicesDeleteTemplateRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.exists.ESIndicesExistsAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.exists.ESIndicesExistsRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.exists.ESIndicesExistsRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.flush.ESIndicesFlushIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.flush.ESIndicesFlushIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.flush.ESIndicesFlushIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.frozen.ESIndicesFreezeIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.frozen.ESIndicesFreezeIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.frozen.ESIndicesFreezeIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.getalias.ESIndicesGetAliasAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.getalias.ESIndicesGetAliasRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.getalias.ESIndicesGetAliasRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.getindex.ESIndicesGetIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.getindex.ESIndicesGetIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.getindex.ESIndicesGetIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.gettemplate.ESIndicesGetTemplateAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.gettemplate.ESIndicesGetTemplateRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.gettemplate.ESIndicesGetTemplateRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.openindex.ESIndicesOpenIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.openindex.ESIndicesOpenIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.openindex.ESIndicesOpenIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.putalias.ESIndicesPutAliasAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.putalias.ESIndicesPutAliasRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.putalias.ESIndicesPutAliasRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.putindex.ESIndicesPutIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.putindex.ESIndicesPutIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.putindex.ESIndicesPutIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.puttemplate.ESIndicesPutTemplateAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.puttemplate.ESIndicesPutTemplateRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.puttemplate.ESIndicesPutTemplateRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.refreshindex.ESIndicesRefreshIndexAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.refreshindex.ESIndicesRefreshIndexRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.refreshindex.ESIndicesRefreshIndexRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.searchshards.ESIndicesSearchShardsAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.searchshards.ESIndicesSearchShardsRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.searchshards.ESIndicesSearchShardsRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.stats.ESIndicesStatsAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.stats.ESIndicesStatsRequest;
import com.didiglobal.knowframework.elasticsearch.client.request.index.stats.ESIndicesStatsRequestBuilder;
import com.didiglobal.knowframework.elasticsearch.client.request.index.updatemapping.ESIndicesUpdateMappingAction;
import com.didiglobal.knowframework.elasticsearch.client.request.index.updatemapping.ESIndicesUpdateMappingRequest;
...
import com.didiglobal.knowframework.elasticsearch.client.response.indices.flush.ESIndicesFlushIndexResponse;
import com.didiglobal.knowframework.elasticsearch.client.response.indices.frozen.ESIndicesFreezeIndexResponse;
...
import com.didiglobal.knowframework.elasticsearch.client.response.indices.searchshards.ESIndicesSearchShardsResponse;
