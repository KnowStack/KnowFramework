package com.didichuxing.tunnel.util.common.web.filter;

import com.didichuxing.tunnel.util.common.URLHelper;
...
import static com.didichuxing.tunnel.util.common.web.WebConstants.USER_HEADER_KEY;
...
public class WebRequestLogFilter implements Ordered, Filter {
    ...
    private Map<String, String> getHeaders(HttpServletRequest request) {
        ...
        params.put(USER_HEADER_KEY, request.getHeader(USER_HEADER_KEY));
