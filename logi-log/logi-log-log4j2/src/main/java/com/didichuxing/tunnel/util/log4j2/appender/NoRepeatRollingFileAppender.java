...
 */
package com.didichuxing.tunnel.util.log4j2.appender;
...
public class NoRepeatRollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {
     ...
     *            The type to build
     */
    public static class Builder<B extends NoRepeatRollingFileAppender.Builder<B>>
     ...
     */
    @Deprecated
    public static <B extends NoRepeatRollingFileAppender.Builder<B>> NoRepeatRollingFileAppender createAppender(
                                                                                                                // @formatter:off
    ...
    public static <B extends NoRepeatRollingFileAppender.Builder<B>> B newBuilder() {
        return new NoRepeatRollingFileAppender.Builder<B>().asBuilder();
    }
}
