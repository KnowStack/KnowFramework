...
import com.didichuxing.datachannel.metrics.impl.MetricsSystemImpl;
...
public enum DefaultMetricsSystem implements MetricsSystem {
    ...
    /**
     * Common static method to unregister a source
     * @param name  of the source
     * @return the source object
     */
    public static MetricsSource unRegisterSource(String name) {
        return INSTANCE.unRegister(name);
    }

    @Override
    public MetricsSource unRegister(final String name) {
        return impl.unRegister(name);
    }
