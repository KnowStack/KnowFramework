...
package com.didichuxing.datachannel.metrics.lib;
...
public class MetricMutableFactory {
    ...
    public MetricMutablePeriodGaugeInt newPeriodGauge(String name, String description, int initValue) {
        return new MetricMutablePeriodGaugeInt(name, description, initValue);
    }
     ...
     * @return  a new metric object
     */
    public MetricMutablePeriodGaugeInt newPeriodGaugeInt(String name) {
        return new MetricMutablePeriodGaugeInt(name, Metric.NO_DESCRIPTION, 0);
    }

    /**
     * Create a mutable reference metric with initializer value.
     * Usually gets overridden.
     * @param name  of the metric
    ...
    public <T> MetricMutableReference<T> newReference(String name, String description, T initValue) {
        return new MetricMutableReference<T>(name, description, initValue);
    }
     ...
     * @return  a new metric object
     */
    public MetricMutablePeriodGaugeLong newPeriodGauageLong(String name) {
        return new MetricMutablePeriodGaugeLong(name, Metric.NO_DESCRIPTION, 0L);
    }
    ...
    public MetricMutableStat newStat(String name) {
        return new MetricMutableStat(name, name, DEFAULT_SAMPLE_NAME, DEFAULT_VALUE_NAME);
    }
