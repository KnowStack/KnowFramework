...
package com.didiglobal.knowframework.metrics.sink.ganglia;
...
class GangliaConf {
    ...
    public String toString() {
        ...
        buf.append("unit=").append(units).append(", slope=").append(slope).append(", dmax=").append(dmax)
     ...
     */
    void setSlope(AbstractGangliaSink.GangliaSlope slope) {
        this.slope = slope;
    }
