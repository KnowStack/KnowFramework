...
import com.didiglobal.knowframework.metrics.lib.MetricMutableCounterInt;
import com.didiglobal.knowframework.metrics.lib.MetricMutableGaugeInt;
        ...
        sinkThread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    LOG.warn("fail to publishMetricFromQueue", e);
                }
            }
        };
