...
//import com.didiglobal.knowframework.dsl.parse.dsl.parser.query.QueryStringParser;
//import com.didiglobal.knowframework.dsl.parse.dsl.visitor.FormatVisitor;
//import com.didiglobal.knowframework.dsl.parse.dsl.visitor.GetInfoVisitor;
//import com.didiglobal.knowframework.dsl.parse.dsl.visitor.OutputJsonVisitor;
//import com.didiglobal.knowframework.dsl.parse.dsl.visitor.basic.OutputVisitor;
//import com.didiglobal.knowframework.dsl.parse.sql.EsExportParameterVisitor;
...
//        String fileName = DslParserTest.class.getClassLoader().getResource("dsl.txt").getFile();
//        List<String> lines = Files.readAllLines(Paths.get(fileName));
//
//        List<String> errorDsls = Lists.newArrayList();
//        int count = 0;
//        for(String l : lines) {
...
//        }
//        System.out.println("count -> " + errorDsls.size());
//    }
//
//    @Test
...
//
//        dsl = "select * from dos_order_201904 where order_base.passenger_id=565988794369892 and order_base.product_id in(1,2,3,4,5,6,7,8,9,13,14,22,20) and order_base.area=1 and order_base._birth_time between '2019-04-08T00:00:00.000+0800' and '2019-04-10T00:00:00.000+0800' order by order_base._birth_time desc limit 0,10";
//
//        ExtractResult er = DslExtractionUtil.extractDsl(dsl);
//        System.out.println(er.getDslTemplateMd5());
//        System.out.println(er.getDslTemplate());
//    }
//
//    @Test
...
//        QueryStringParser queryStringParser = new QueryStringParser(ParserType.QUERY);
//
//        String fileName = DslParserTest.class.getClassLoader().getResource("query").getFile();
//        List<String> lines = Files.readAllLines(Paths.get(fileName));
//        for(String l : lines) {
...
//    }
//
//    public boolean parser(String dsl) throws Exception {
//
