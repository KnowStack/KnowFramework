...
// * @Modified By
// */
//public class EsExportParameterVisitorTest {
//
//    @Test
...
//
//        String filePath = EsExportParameterVisitorTest.class.getClassLoader().getResource("sql.txt").getPath();
...
//
//        String filePath = EsExportParameterVisitorTest.class.getClassLoader().getResource("dsl_1.txt").getPath();
//        Path path = Paths.get(filePath);
//        if (Files.exists(path)) {
//            List<String> lines = Files.readAllLines(path);
//            for (String line : lines) {
