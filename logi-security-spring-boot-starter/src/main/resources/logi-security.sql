...
(
    ...
    read_tag    tinyint(1) default 0                 not null comment '是否已读',
...
(
    ...
    operator_username varchar(20)                          not null comment '操作者账号',
...
create table logi_project_resource
(
    project_id       int         null,
