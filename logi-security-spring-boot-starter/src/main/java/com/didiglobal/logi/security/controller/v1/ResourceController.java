...
public class ResourceController {
    ...
    public Result<Boolean> vpcStatus() {
        boolean isOn = resourceService.getViewPermissionControlStatus();
    ...
    public Result<String> vpcSwitch() {
        resourceService.changeResourceViewControlStatus();
    ...
    public Result<String> mbrAssign(@RequestBody AssignToManyUserDTO assignToManyUserDTO) {
        resourceService.assignResourcePermission(assignToManyUserDTO);
        return Result.success();
    }
    ...
    public Result<String> mbuAssign(@RequestBody AssignToOneUserDTO assignToOneUserDTO) {
        resourceService.assignResourcePermission(assignToOneUserDTO);
        return Result.success();
    }
